...
node() {
    ...
    stage("Prepare") {
        service = toolbox.prepareThreescaleService(
            ...
            service: [:],
            applications: [
                [name: "my-test-planet-app", description: "This is used for tests", plan: "test", account: 17]
            ],
            applicationPlans: [
    ...
    curl -f -w "Get Planets: %{http_code}\n" -o /dev/null -s ${proxy.sandbox_endpoint}/api/v1/planets -H 'api-key: ${service.applications[0].userkey}'
    """
    }
